...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox CssClass="form-control mb-4 mt-2" MaxLength="2" runat="server" ID="PISO_CODIGO" />
    <label>Nombre del Bloque</label>
    <asp:TextBox CssClass="form-control mb-4 mt-2" MaxLength="50" runat="server" ID="PISO_NOMBRE" />
    <label>Estado</label>
    <asp:DropDownList CssClass="form-control mb-4 mt-2" runat="server" ID="PISO_ESTADO" />
    <label>Observacion</label>
    <asp:TextBox CssClass="form-control flex-wrap mt-2" TextMode="MultiLine" Rows="4"  runat="server" ID="PISO_OBSERVACION" /> 
