...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox CssClass="form-control mb-3 mt-2" MaxLength="100" runat="server" ID="TIPO_OCUPANTE_NOMBRE" />
    <label>Detalle</label>
    <asp:TextBox CssClass="form-control mb-3 mt-2" runat="server" ID="TIPO_OCUPANTE_DETALLE" />
    <label>Estado</label>
    <asp:DropDownList CssClass="form-control mb-3 mt-2" runat="server" ID="TIPO_OCUPANTE_ESTADO" />
