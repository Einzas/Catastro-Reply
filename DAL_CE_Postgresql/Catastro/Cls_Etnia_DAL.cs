...
namespace DAL_CE_Postgresql.Catastro
{
    public class Cls_Etnia_DAL
    {
        ...
        public DataTable Consultar()
        {
            ...
            string query = "select etnia_id, etnia_nombre, etnia_detalle, etnia_estado " +
                "from catastroestablecimiento.cm_etnia " +
                "order by etnia_id asc;";
        ...
        public DataTable ConsultarID(int id)
        {
            ...
            string query = "select etnia_id, etnia_nombre, etnia_detalle, etnia_estado " +
                "from catastroestablecimiento.cm_etnia " +
                "where etnia_id = " + id + " order by etnia_id asc;";
            NpgsqlCommand conector = null;
            NpgsqlDataAdapter datos = null;
            DataTable tabla = new DataTable();
            try
        ...
        public DataTable Etnia()
        {
            NpgsqlConnection con = null;
            string query = "select etnia_id, etnia_nombre from catastroestablecimiento.cm_etnia order by etnia_id asc;";
            NpgsqlCommand conector = null;
            NpgsqlDataAdapter datos = null;
            DataTable tabla = new DataTable();
            try
        ...
        public void Insertar(string nombre, string detalle, int estado)
        {
            ...
            try
            {
                con = conexion.EstablecerConexion();
                string query =
                "Insert into catastroestablecimiento.cm_etnia (etnia_nombre, etnia_detalle, etnia_estado) " +
        ...
        public void Editar(string nombre, string detalle, int estado, int id)
        {
            ...
            {
                con = conexion.EstablecerConexion();
                string query = "update catastroestablecimiento.cm_etnia set " +
                "etnia_nombre = '" + nombre + "', " +
                "etnia_detalle = '" + detalle + "', " +
                "etnia_estado = " + estado +
                " where etnia_id = " + id + "";
        ...
        public void Eliminar(int id)
        {
            ...
            {
                con = conexion.EstablecerConexion();
                string query = "delete from catastroestablecimiento.cm_etnia where etnia_id = " + id + "";
